                  ...
                  <nav id="header-navigation" className="header-standard-position">
                    <div className="sh-nav-container">
                      <ul id="menu-menu-1" className="sh-nav">
                        ...
                        <li id="menu-item-740"
                          className="menu-item menu-item-type-custom menu-item-object-custom menu-item-740"><a
                            href="#blog">Blog</a></li>
          ...
          <div className="fw-page-builder-content">
            <section
              ...
              <div className="sh-section-container container">
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-heading sh-heading-style1 sh-animated zoomIn"
                        ...
                        <h1 className="sh-heading-content size-xxl">
                          <span style={{textAlign: 'left'}}>Your cryptocurrency</span><span
                            style={{textAlign: 'left'}}>project website</span><span style={{textAlign: 'left'}}/>
                        </h1>
                      </div>
                      ...
                      <div id="text-block-2c6901a4bbc217b2f69631bfaa972d18" className="sh-text-block">
                        <p><span style={{fontSize: '16px'}}>Description about coin and ICO event in deatale that you think
                            your clients might find suitable</span></p>
                      </div>
                    ...
                    <div className="sh-column-wrapper">
                      <div id="button-4f9d3fba0f31cf799095f9515088e51d" className="sh-button-container  sh-button-style-1">
                        <div className="sh-element-margin">
                          <a href="#" target="_self" className="sh-button sh-button-large ">
                  ...
                  <div
                    ...
                    <div className="sh-column-wrapper">
                      <div id="button-16f174007b35358724c761c465661663" className="sh-button-container  sh-button-style-1">
                        <div className="sh-element-margin">
                          <a href="#" target="_self" className="sh-button sh-button-large sh-button-icon-left">
                ...
                <div className="fw-row">
                  <div
                    className="sh-column sh-column-f5a90021ba4637794f035af8cdbfa9c0 fw-col-xs-12 fw-col-sm-6 sh-animated fadeIn"
                    data-wow-duration="2s">
                    <div className="sh-column-wrapper">
                      <div className="sh-empty-space" id="empty-space-0d1c96eaa4b6bf8e5490e24161f5ee3a"></div>
                      <div className="sh-heading sh-heading-style1" id="heading-c9103619e606c392c2389f90931c0385">
                        <h1 className="sh-heading-content size-m">
                  ...
                  <div className="sh-column sh-column-6f436be512ebd3f2330a3305cffc630b fw-col-xs-12 fw-col-sm-6">
                    <div className="sh-column-wrapper">
                    </div>
                  </div>
                </div>
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-heading sh-heading-style1" id="heading-048298abf445bf8e82354a7a3d955c40">
                        <h1 className="sh-heading-content size-l">
                          <span style={{textAlign: 'left'}}>Main Facts</span><span style={{textAlign: 'left'}}>About Our
                            Coin And</span><span style={{textAlign: 'left'}}>Bussiness Model</span>
                        </h1>
                      </div>
                    </div>
                  </div>
                  <div
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-heading sh-heading-style1" id="heading-117f37a4d2987ba49ccddf9dde3c705f">
                        <h1 className="sh-heading-content size-m">
                          <span style={{textAlign: 'center'}}>SMART WALLET</span>
                        </h1>
                      </div>
                      ...
                      <div id="text-block-63d5e28417d37148b0bbe88465067cfb" className="sh-text-block">
                        <p style={{textAlign: 'center'}}><span style={{fontSize: '14px'}}>Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Sed et lobortis metus. Proin vel mauris pulvinar, lacinia neque
                            sed, posuere sem aliquet.</span></p>
                      </div>
                    </div>
                  </div>
                  <div
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-heading sh-heading-style1" id="heading-dcfbe20e6621d8c7f6351a2bb20fe488">
                        <h1 className="sh-heading-content size-m">
                          <span style={{textAlign: 'center'}}>INSTANT PAYOUTS</span>
                        </h1>
                      </div>
                  ...
                  <div
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-heading sh-heading-style1" id="heading-295d9546f086b1a07601e3f9c4d777c6">
                        <h1 className="sh-heading-content size-m">
                          <span style={{textAlign: 'center'}}>NO DEPOSTS</span>
                        </h1>
                      </div>
                  ...
                  <div
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-heading sh-heading-style1" id="heading-9ecbb52a973367a4337c5a5d2908b536">
                        <h1 className="sh-heading-content size-m">
                          <span style={{textAlign: 'center'}}>GLOBAL</span>
                        </h1>
                      </div>
                  ...
                  <div
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-heading sh-heading-style1" id="heading-c97c155a58b283c24360913d626b32e9">
                        <h1 className="sh-heading-content size-m">
                          <span style={{textAlign: 'center'}}>SIMPLE</span>
                        </h1>
                      </div>
                  ...
                  <div
                    ...
                    <div className="sh-column-wrapper">
                      <div className="sh-heading sh-heading-style1" id="heading-3773adbe4e1916a8822f803ebb12f139">
                        <h1 className="sh-heading-content size-l">
                          <span style={{textAlign: 'left'}}>Token Distribution</span>
                        </h1>
                      </div>
                      ...
                      <div id="text-block-3b865619c2b119bc5c1a8f513f152a4b" className="sh-text-block">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus gravida lacinia tellus,
                          vitae condimentum purus tristique sed.</p>
                        <p><span style={{color: '#f3ba40'}}>Integer at lorem</span> eget diam facilisis lacinia ac id
                          massa. Nulla facilisi. Duis ornare facilisis ex non porttitor. Suspendisse potenti. Sed luctus
                          suscipit tincidunt. Ornare facilisis ex non porttitor. Suspendisse potenti. Sed luctus
                          suscipit tincidunt.</p>
                      </div>
                      <div className="sh-empty-space" id="empty-space-e3fdc4d74ff5cbec1460fb342f725d60"></div>
                      <div id="progress-8fdd4bd6543c62ee0a49fa23eeeba594" className="sh-progress sh-progress-style4">
                        <div className="sh-progress-item">
                          <div className="row">
                            <div className="col-md-8 col-sm-8 col-xs-8">
                              <div className="sh-progress-title sh-heading-font">
                                Comunity </div>
                            </div>
                          ...
                          <div className="sh-progress-content">
                            <div className="sh-progress-content-container">
                              <div className="sh-progress-status">
                                <div className="sh-progress-status-value" data-width="77"></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="sh-empty-space" id="empty-space-376b6155c330bf12db087ef24b4e50fd"></div>
                      <div id="progress-a42ea4ff7db942da13c4131187f75802" className="sh-progress sh-progress-style4">
                        <div className="sh-progress-item">
                          <div className="row">
                            <div className="col-md-8 col-sm-8 col-xs-8">
                              <div className="sh-progress-title sh-heading-font">
                                Team and Developers </div>
                            </div>
                            <div className="col-md-4 col-sm-4 col-xs-4">
                              <div className="sh-progress-value2">
                                65%
                          ...
                          <div className="sh-progress-content">
                            <div className="sh-progress-content-container">
                              <div className="sh-progress-status">
                                <div className="sh-progress-status-value" data-width="65"></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="sh-empty-space" id="empty-space-24add97c720e6db383b7a83220c9427e"></div>
                      <div id="progress-66eca2cd7ee88c33d12360e6b5ae1644" className="sh-progress sh-progress-style4">
                        <div className="sh-progress-item">
                          <div className="row">
                            <div className="col-md-8 col-sm-8 col-xs-8">
                              <div className="sh-progress-title sh-heading-font">
                                Token Sale and Pre-Sale </div>
                            </div>
                            <div className="col-md-4 col-sm-4 col-xs-4">
                              <div className="sh-progress-value2">
                                88%
                          ...
                          <div className="sh-progress-content">
                            <div className="sh-progress-content-container">
                              <div className="sh-progress-status">
                                <div className="sh-progress-status-value" data-width="88"></div>
                              </div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="sh-empty-space" id="empty-space-8f9a947b847681c0c2b7b828acba1574"></div>
                      <div id="progress-75a495483c97bd21b55d006d7dc3fb7b" className="sh-progress sh-progress-style4">
                        <div className="sh-progress-item">
                          <div className="row">
                            <div className="col-md-8 col-sm-8 col-xs-8">
                              <div className="sh-progress-title sh-heading-font">
                          ...
                          <div className="sh-progress-content">
                            <div className="sh-progress-content-container">
                              <div className="sh-progress-status">
                                <div className="sh-progress-status-value" data-width="10"></div>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="sh-column-wrapper">
                      ...
                      <div className="sh-iconbox sh-iconbox-style12 sh-iconbox-left improved-responsiveness"
                        ...
                        <div className="sh-iconbox-aside">
                          ...
                          <div className="sh-iconbox-content">
                            <p><span style={{fontSize: '12px', color: '#ffffff'}}>February, 2017</span></p>
                            <p><span style={{fontSize: '14px'}}> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Cras interdum sed nibh sit amet accumsan. Suspendisse posuere congue ante quis
                                fringilla. </span></p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="sh-iconbox sh-iconbox-style12 sh-iconbox-left improved-responsiveness"
                        ...
                        <div className="sh-iconbox-aside">
                          ...
                          <div className="sh-iconbox-seperator"></div>
                          <div className="sh-iconbox-content">
                            <p><span  style={{fontSize: '12px', color: '#ffffff'}}>July, 2017</span></p>
                            <p><span  style={{fontSize: '14px'}}> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Cras interdum sed nibh sit amet accumsan. Suspendisse posuere congue ante quis
                                fringilla. </span></p>
                          </div>
                      ...
                      <div className="sh-iconbox sh-iconbox-style12 sh-iconbox-left improved-responsiveness"
                        ...
                        <div className="sh-iconbox-aside">
                          <div className="sh-iconbox-title">
                            <h3>Commercial lounch</h3>
                          </div>
                          <div className="sh-iconbox-seperator"></div>
                          <div className="sh-iconbox-content">
                            <p><span  style={{fontSize: '12px', color: '#ffffff'}}>January, 2018</span></p>
                            <p><span  style={{fontSize: '12px'}}> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Cras interdum sed nibh sit amet accumsan. Suspendisse posuere congue ante quis
                                fringilla. </span></p>
                          </div>
                        </div>
                      ...
                      <div className="sh-iconbox sh-iconbox-style12 sh-iconbox-left improved-responsiveness"
                        ...
                        <div className="sh-iconbox-aside">
                          <div className="sh-iconbox-title">
                            <h3>First clients onboarded</h3>
                          </div>
                          <div className="sh-iconbox-seperator"></div>
                          <div className="sh-iconbox-content">
                            <p><span  style={{fontSize: '12px', color: '#ffffff'}}>September, 2018</span></p>
                            <p><span  style={{fontSize: '14px'}}> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Cras interdum sed nibh sit amet accumsan. Suspendisse posuere congue ante quis
                                fringilla. </span></p>
                          </div>
                      ...
                      <div className="sh-iconbox sh-iconbox-style12 sh-iconbox-left improved-responsiveness"
                        ...
                        <div className="sh-iconbox-aside">
                          ...
                          <div className="sh-iconbox-seperator"></div>
                          <div className="sh-iconbox-content">
                            <p><span  style={{fontSize: '12px', color: '#ffffff'}}>March, 2019</span></p>
                            <p><span  style={{fontSize: '14px'}}> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Cras interdum sed nibh sit amet accumsan. Suspendisse posuere congue ante quis
                                fringilla. </span></p>
                          </div>
